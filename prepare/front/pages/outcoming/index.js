                            ...
                            >
                                ...
                                <Form.Item name="payment" label="결제 수단">
                                    ...
                                    >
                                        ...
                                        <Radio value={'cardAndCash'}>
                                            카드 + 현금
                                        </Radio>
                                        <Radio value={'cardAndRemit'}>
                                            카드 + 송금
                                        </Radio>
                                    </Radio.Group>
                                </Form.Item>
                                    ...
                                    rules={[
                                        {
                                            required: true,
                                            message:
                                                '교복의 이월, 신상, 전이 여부를 선택해주세요',
                                        },
                                    ]}
                                >
                                    <Select
                                        style={widthStyle}
                                        placeholder="이월/신상/전이"
                                    >
